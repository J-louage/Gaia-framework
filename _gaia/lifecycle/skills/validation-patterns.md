...
description: 'Reusable validation patterns for claim extraction, filesystem verification, cross-referencing, severity classification, and findings formatting.'
